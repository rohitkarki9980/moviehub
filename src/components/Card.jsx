...
const Card = ({ movie }) => {
  ...
  return (
    <>
      <div className="mt-4 w-full max-w-sm bg-gray-200 border border-gray-200 rounded-lg">
        <Link to="#">
          <img className="p-5 rounded-t-lg" src={movie.image} />
        </Link>
        <div className="px-5 pb-5">
          ...
          <div className="flex items-center justify-between bottom-0">
            ...
            <Link
              to={`/movie/${movie.id}`}
              className="text-md  text-white hover:bg-stone-700 bg-stone-900 border rounded-md p-2"
            >
              View Details
            </Link>
          </div>
