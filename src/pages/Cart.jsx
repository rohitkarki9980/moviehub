                            ...
                            <tbody>
                                {
                                    cart_items.map((cart_item, i) => {
                                        ...
                                        return <tr key={i}>
                                            ...
                                            <td><button onClick={handleRemove(cart_item.cart_id)} className='text-black bg-gradient-to-t from-gray-400 via-rose-100 to-blue-300  rounded-md px-2.5 py-1 hover:from-blue-200 hover:to-gray-200'>Remove</button></td>
                                        </tr>
                                    })
                                }
                            </tbody>
